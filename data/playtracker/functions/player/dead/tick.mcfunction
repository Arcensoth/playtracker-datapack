...
execute as @s[tag=!playtracker.dead,scores={ptrak_sincedeath=0}] run function playtracker:player/dead/died
...
execute as @s[tag=playtracker.dead,scores={ptrak_sincedeath=1..}] run function playtracker:player/dead/respawned
