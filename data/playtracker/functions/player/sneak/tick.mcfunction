...
execute as @s[tag=!playtracker.sneaking,scores={ptrak_snkflag=1..}] run function playtracker:player/sneak/start
...
execute as @s[tag=playtracker.sneaking,scores={ptrak_snkflag=0}] run function playtracker:player/sneak/stop
