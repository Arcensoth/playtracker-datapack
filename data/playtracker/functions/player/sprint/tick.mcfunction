# playtracker:player/sprint/tick

# see sneak submodule for explanations

tag @s[tag=playtracker.sprinting.started] remove playtracker.sprinting.started
execute as @s[tag=!playtracker.sprinting,scores={ptrak_sprflag=1..}] run function playtracker:player/sprint/start
tag @s[tag=playtracker.sprinting.stopped] remove playtracker.sprinting.stopped
execute as @s[tag=playtracker.sprinting,scores={ptrak_sprflag=0}] run function playtracker:player/sprint/stop
